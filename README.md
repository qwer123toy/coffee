...
- 🖼️ **스마트 이미지**: 자동 이미지 감지 및 fallback 시스템
...
```bash
# 프로젝트 클론
git clone https://github.com/qwer123toy/coffee.git
cd coffee
...
### 3. JSP 버전 실행 (Tomcat 필요)
```bash
# Tomcat 설치 후
cp -r coffee/ $TOMCAT_HOME/webapps/
...
프로젝트에서 사용하는 이미지들의 권장 사이즈:

- **Hero Background**: 1920x1080 (16:9)
- **Brand Story**: 800x500 (8:5)
- **Menu Items**: 400x400 (1:1)
- **Store Images**: 600x400 (3:2)
- **Event Banners**: 800x400 (2:1)
